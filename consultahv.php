       ...
       <?php include("conexion.php") ?>
        ...
        <div class="content" style="padding: 40px;">
            ...
            <div class="row">
                ...
                <h3 class="card-title" style="text-align: center;">HOJAS DE VIDA</h3>
                
                <div class="form-group mx-sm-3 mb-2">
                   <label class="checkbox-inline">
                    <input type="text" class="form-control" id="filtro" placeholder="Cedula">
                    </label>
                    <label class="checkbox-inline">
                       <button id="seleccionado" class="btn btn-primary mb-2">Buscar</button>
                    </label>
                </div>
